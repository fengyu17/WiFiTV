...
public final class RSAUtils {
	 ...
	 * @return
	 * 
	 *         public static KeyPair generateRSAKeyPair() { return
	 ...
	 * @return
	 * 
	 *         public static KeyPair generateRSAKeyPair(int keyLength) { try {
	 *         KeyPairGenerator kpg = KeyPairGenerator.getInstance(RSA);
	 *         kpg.initialize(keyLength); return kpg.genKeyPair(); } catch
	 ...
	 *             keyFactory.generatePrivate(keySpec); return privateKey; }
	 * 
	 *             /** 使用N、e值还原公钥
	 * 
	 * @param modulus
	 ...
	 *             publicExponent) throws NoSuchAlgorithmException,
	 *             InvalidKeySpecException { BigInteger bigIntModulus = new
	 *             BigInteger(modulus); BigInteger bigIntPrivateExponent = new
	 *             BigInteger(publicExponent); RSAPublicKeySpec keySpec = new
	 ...
	 *             privateExponent) throws NoSuchAlgorithmException,
	 *             InvalidKeySpecException { BigInteger bigIntModulus = new
	 *             BigInteger(modulus); BigInteger bigIntPrivateExponent = new
	 *             BigInteger(privateExponent); RSAPublicKeySpec keySpec = new
	 *             RSAPublicKeySpec(bigIntModulus, bigIntPrivateExponent);
	 *             KeyFactory keyFactory = KeyFactory.getInstance(RSA);
